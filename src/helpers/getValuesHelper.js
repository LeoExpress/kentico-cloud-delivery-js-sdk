          ...
          config[keyContent][keyElement].forEach((itemElement) => {
            ...
            if (keyElement === 'elements') {
              ...
              if (typeof itemElement === 'string' && item[keyElement][itemElement].type === 'asset') {
                ...
                tempObject[keyElement][itemElement] = getArrayValues(tempObject[keyElement][itemElement], item[keyElement][itemElement], 'url')
                ...
                tempObject[keyElement][itemElement] = getArrayValues(tempObject[keyElement][itemElement], item[keyElement][itemElement], 'codename')
                ...
                tempObject[keyElement][itemElement] = getRichTextModularContent(item[keyElement][itemElement], content[keyContent]['modular_content'])
                      ...
                      itemElement[keyModularElement].forEach((itemModularConfig) => {
                        ...
                        if (keyModularElement === 'elements') {
                          if (content[keyContent]['modular_content'][itemModular][keyModularElement][itemModularConfig].type === 'asset') {
                            tempModularObject[keyModularElement][itemModularConfig] = getArrayValues(tempModularObject[keyModularElement][itemModularConfig], content[keyContent]['modular_content'][itemModular][keyModularElement][itemModularConfig], 'url')
                            ...
                            tempModularObject[keyModularElement][itemModularConfig] = getArrayValues(tempModularObject[keyModularElement][itemModularConfig], content[keyContent]['modular_content'][itemModular][keyModularElement][itemModularConfig], 'codename')
                          } else {
